 ...
 */
export type AvifEncoderFactory = ((imageData: ImageInput, options?: AvifEncodeInputOptions, signal?: AbortSignal) => Promise<Uint8Array>) & {
    /**
 ...
 * Can be terminated to clean up associated resources (especially workers).
 */
export type AvifDecoderFactory = ((buffer: BufferSource, signal?: AbortSignal) => Promise<ImageData>) & {
    /**
 ...
 */
export declare function encode(imageData: ImageInput, options?: AvifEncodeInputOptions, signal?: AbortSignal): Promise<Uint8Array>;
/**
 ...
 */
export declare function decode(buffer: BufferSource, signal?: AbortSignal): Promise<ImageData>;
/**
 ...
 */
export declare function createAvifEncoder(mode?: 'worker' | 'client'): AvifEncoderFactory;
/**
 ...
 */
export declare function createAvifDecoder(mode?: 'worker' | 'client'): AvifDecoderFactory;
