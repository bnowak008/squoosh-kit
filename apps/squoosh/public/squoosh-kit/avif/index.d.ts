 ...
 */
export type AvifEncoderFactory = ((imageData: ImageInput, options?: AvifEncodeOptions, signal?: AbortSignal) => Promise<Uint8Array>) & {
    /**
 ...
 */
export type AvifDecoderFactory = ((data: BufferSource, signal?: AbortSignal) => Promise<ImageData>) & {
    /**
 ...
 */
export declare function encode(imageData: ImageInput, options?: AvifEncodeOptions, signal?: AbortSignal): Promise<Uint8Array>;
/**
