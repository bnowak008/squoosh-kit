 ...
 */
export type RotatorFactory = ((image: ImageInput, options?: RotateOptions, signal?: AbortSignal) => Promise<ImageInput>) & {
    /**
 ...
 */
export declare function rotate(image: ImageInput, options?: RotateOptions, signal?: AbortSignal): Promise<ImageInput>;
/**
