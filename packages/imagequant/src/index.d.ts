 ...
 */
export type ImagequantQuantizerFactory = ((image: ImageInput, options?: ImagequantOptions, signal?: AbortSignal) => Promise<{
 ...
 */
export declare function quantize(image: ImageInput, options?: ImagequantOptions, signal?: AbortSignal): Promise<{
    data: Uint8ClampedArray;
    width: number;
    height: number;
}>;
